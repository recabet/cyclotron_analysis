...
class SimulationConfig:
    ...
    COMPOUNDS_FILE: str = "../data/compounds/compounds_660000hz_at_10T_short.txt"

    # ----------------------------------------
    # Signal acquisition parameters
    # ----------------------------------------
    SAMPLING_RATE: float = 1e6  # Hz
    N_POINTS_FID: int = 2 ** 16  # 65536 points
...
class TrainingConfig:
    ...
    # Paths
    H5_PATH: str = "../data/waves/segments/training_segments_65536.h5"  # generated by generate_training_data.py
    X_KEY: str = "fft_low"
    Y_KEY: str = "fft_hr"
